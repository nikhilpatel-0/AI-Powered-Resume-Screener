    ...
    <div>
      <div className='grid pt-20 pb-10 px-5 md:flex'>
        <div>
          ...
          <h1 className='md:text-8xl sm:text-5xl text-5xl font-semibold text-white tracking-tight mt-4 text-start'>Optimize Your Resume with AI</h1>
          <p className='mt-4 md:text-3xl text-slate-300 text-base sm:text-lg font-sans text-start'>Upload your resume and job description, and let AI suggest improvements.</p>
        ...
        <div className='grid grid-cols-2 gap-4'>
          <div className='rounded-xl bg-white/5 p-4 ring-1 ring-white/10'>
            <div className='flex items-center gap-2 text-slate-200'>
              ...
              <span className='text-lg font-medium font-sans'>Resume Fit</span>
            </div>
            <p className='mt-3 text-sm text-slate-400 font-sans'>Skill coverage • Keyword match • Format score</p>
          ...
          <div className='flex items-center gap-2 text-slate-200'>
            ...
            <span className='text-lg font-medium font-sans'>ATS Check</span>
          </div>
          ...
          <div className='col-span-2 rounded-xl bg-gradient-to-r from-blue-500/10 to-indigo-500/10 p-4 ring-1 ring-white/10'>
            <div className='flex items-center justify-between'>
              <div className='flex items-center gap-2 text-slate-200 '>
                <i class="ri-shining-line text-lg"></i>
                <span className='text-lg'>Tailored Suggestions</span>
              </div>
              <span className='text-xs text-slate-400 font-sans'>Live preview</span>
            </div>
            <p className='mt-2 text-sm text-slate-300 font-sans'>Replace passive verbs, quantify achievements, and align with role requirements.</p>
          </div>
          </div>
        </div>
      </div>
